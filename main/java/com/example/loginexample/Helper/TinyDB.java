...
public class TinyDB {
    ...
    public ArrayList<Article_ViewModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Article_ViewModel> playerList =  new ArrayList<Article_ViewModel>();

        for(String jObjString : objStrings){
            Article_ViewModel player  = gson.fromJson(jObjString,  Article_ViewModel.class);
    ...
    public void putListObject(String key, ArrayList<Article_ViewModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Article_ViewModel player: playerList){
