...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    private ArrayList<Article_ViewModel> foodDomains;
    private ManagementCart managementCart;
    private ChangeNumberItemsListener changeNumberItemsListener;

    public CartListAdapter(ArrayList<Article_ViewModel> foodDomains, Context context, ChangeNumberItemsListener changeNumberItemsListener) {
    ...
    public void onBindViewHolder(@NonNull CartListAdapter.ViewHolder holder, int position) {
        ...
        int drawableReourceId = holder.itemView.getContext().getResources().getIdentifier(
                String.valueOf(foodDomains.get(position).getImageId())
